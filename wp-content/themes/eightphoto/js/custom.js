jQuery(document).ready(function ($) {
    ...
    $('.boxed-layout .ed-toggle-nav').click(function(){
        $('.boxed-layout .primary-nav-menu').slideToggle();
    });
    $('.boxed-layout li.menu-item-has-children').append('<span><i class="fa fa-caret-down"></i></span>');
    if ($(window).width()<=980){
        $('body').on('click','li.menu-item-has-children span',function(){
    ...
    $(window).load(function () {
        $(".fullwidth-layout .primary-nav-menu").customScrollbar();       
    });
